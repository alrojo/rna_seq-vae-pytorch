...
class VAE(nn.Module):
    def __init__(self, input_dim=None, split_dim=None, nhidden=[200,200], nlatent=20, beta=1.0, dropout=0.2, n_samples=3, cuda=False)
    ...
    def training(self, train_loader, epoch, optimizer, p_z, kld_w, n_samples):
        ...
        for batch_idx, (data, mask) in enumerate(train_loader):
            ...
            loss, rec_loss, kld = self.loss_function(data, out, q_z, p_z)
            loss.backward()
